...
@Autonomous(name = "RIGHT - Auto Less Straight Park", group = "Concept")

// will score the preset block and park in observation zone
public class AutoParkLessStraightLEFT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            // move right
            roboController.moveOnXAxis(78, 0.6);
        }
    }
}